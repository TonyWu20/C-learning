                  ...
                  int *result_count)
{
    ...
    int *arr_sizes = malloc(sizeof(int) * n);
    for (int i = 0; i < n; ++i)
    {
        arr[i] = NULL;
        arr_sizes[i] = 0;
    ...
    {
        int qType = queries[i][0], x = queries[i][1], y = queries[i][2];
        switch (qType)
        {
        case 1:
        {
            ...
            arr_sizes[idx]++;
            arr[idx] = realloc(arr[idx], sizeof(int) * arr_sizes[idx]);
            arr[idx][arr_sizes[idx] - 1] = y;
            break;
        }
        case 2:
        {
            ...
            retSize++;
            retArray = realloc(retArray, sizeof(int) * retSize);
            retArray[retSize - 1] = lastAnswer;
            break;
        }
        default:
            break;
